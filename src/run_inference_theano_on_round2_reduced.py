...
v_star_file = '../data/round2/Eflux2_flux_rates_reduced.csv' # --> notebooks/Eflux4A.niger.ipynb
...
v_file = '../data/round2/Eflux2_flux_rates_reduced.csv' # --> notebooks/Eflux4A.niger.ipynb
...
# rename for round 2
with gzip.open('../data/round2/model_reduced.pz', 'wb') as f:
     pickle.dump(pymc_model, f)


with gzip.open('../data/round2/model_data_reduced.pz', 'wb') as f:
    pickle.dump({
        'model': model,
        'vn': vn,
        'en': en,
